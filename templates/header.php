...
// Cek apakah user sudah login, jika belum maka arahkan ke login.php
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard (Dapat diakses semua role) -->
            <li class="nav-item">
            ...
            <!-- Nav Item - Buku Tamu (Muncul jika Role = operator ATAU admin) -->
            <?php if (isset($_SESSION['user_role']) && ($_SESSION['user_role'] == 'operator' || $_SESSION['user_role'] == 'admin')) : ?>
            <li class="nav-item">
            ...
            <!-- Nav Item - Laporan (Dapat diakses semua role) -->
            <li class="nav-item">
            ...
            <!-- Nav Item - User (Hanya Muncul jika Role = admin) -->
